...
final multiRenderList = <ItemInfo>[
  ...
  ItemInfo(
    'Row',
    '行布局，排布方向为横向的Flex布局，可容纳多个组件，其他属性全部一致，详见Flex。',
    '/row',
    const Color(0xffb0d4ec),
    const Color(0xff2999e0),
    5,
  ...
  ItemInfo(
    'Column',
    '列布局,排布方向为纵向的Flex布局，可容纳多个组件，其他属性全部一致，详见Flex。。',
    'column',
    const Color(0xffb0d4ec),
    const Color(0xff2999e0),
    5,
...
final sliverList = <ItemInfo>[
  ...
  ItemInfo(
    'SliverOpacity',
    'Sliver透明度，可容纳一个Sliver家族的子组件，并通过opacity来指定子组件的透明度。',
    'sliver_opacity',
    const Color(0xffecdeb3),
    const Color(0xffeec034),
    5,
...
final otherList = <ItemInfo>[
  ...
  ItemInfo(
    'ErrorWidget',
    '错误组件，用于显示错误信息的组件，红底黄字，开发过程中经常看到。',
    'error_widget',
    const Color(0xfff6dce4),
    const Color(0xffee5a8a),
    3,
